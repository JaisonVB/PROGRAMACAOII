...
def imc(peso, altura):
    ...
    if(calc_imc < 16.0):
        return('IMC = ' + str(calc_imc) + ' Magreza grave')
    if(calc_imc >= 16.0 and calc_imc < 17.0):
        return('IMC = ' + str(calc_imc) + ' Magreza moderada')
    if(calc_imc >= 17.0 and calc_imc < 18.5):
        return('IMC = ' + str(calc_imc) + ' Magreza leve') 
    if(calc_imc >= 18.5 and calc_imc < 25.0):
        return('IMC = ' + str(calc_imc) + ' Saudável')
    if(calc_imc >= 25.0 and calc_imc < 30.0):
        return('IMC = ' + str(calc_imc) + ' Sobrepeso')      
    if(calc_imc >= 30.0 and calc_imc < 35.0):
        return('IMC = ' + str(calc_imc) + ' Obesidade grau 1')          
    if(calc_imc >= 35.0 and calc_imc < 40.0):
        return('IMC = ' + str(calc_imc) + ' Obesidade grau 2')          
    if(calc_imc >= 40.0):
        return('IMC = ' + str(calc_imc) + ' Obesidade mórbida')
